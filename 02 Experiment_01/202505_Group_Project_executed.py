...
#
# ### 2.2 Rationale for Algorithm Configuration Selection
#
...
# ---
#
# This carefully designed set of algorithms provides a evaluation framework, ranging from simple local search methods to sophisticated hybrid approaches, allowing for robust comparison and insights into which strategies work best for the Fantasy League Team Optimization problem.
#
...
def run_experiments(configs, players_data, num_runs=30, parallel=True, max_workers=None, save_csv=True):
    """
...
# %%
# Run experiments
results_df = run_experiments(configs, players_data, num_runs=30, parallel=True, save_csv=True)
